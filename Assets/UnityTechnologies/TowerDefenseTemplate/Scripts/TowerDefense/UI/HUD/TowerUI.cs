...
namespace TowerDefense.UI.HUD
{
	...
	public class TowerUI : MonoBehaviour
	{
		...
		public Text upgradeModifierDescription;
		...
		/// <summary>
		/// The attached modifier upgrade button
		/// </summary>
		public Button upgradeModifierButton;
		...
		public virtual void Show(Tower towerToShow)
		{
			...
			if (upgradeModifierButton != null)
			{
				...
				if (canUpgrade)
				{
					upgradeModifierDescription.text = "Upgrade Modifier";
				}
			}
		...
		{
			GameUI.instance.UpgradeSelectedTowerModifier();
		}
